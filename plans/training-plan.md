...
|------|----------|----------|---------|
| 1 | Treadmill walk or light bike | 5 min | Increase core temperature, blood flow |
| 2 | Dynamic mobility (leg swings, arm circles, hip circles, thoracic rotation) | 3-5 min | Joint prep, ROM |
| 3 | Main lift warm-up ramps: | ~5 min | Neural activation, movement groove |
| | — Empty bar × 8-10 | | |
| | — 50% working weight × 6 | | |
| | — 70% working weight × 4 | | |
| | — 85% working weight × 2 | | |
...
| 3 | **Incline DB Press (30-45°)** | 3 × 8-12 | 7 | 90 sec | Upper chest emphasis. DB allows independent arm work, correcting imbalances. Moderate rep range for hypertrophy stimulus |
...
| 6 | **Tricep Rope Pushdown** | 2 × 10-15 | 7 | 60 sec | Direct tricep work. Triceps get heavy pressing stimulus from bench and incline; this is supplemental isolation. 2 sets is sufficient given pressing volume |

**Total working sets: 19** (17 without optional tricep work)
...
| 2 | **Barbell RDL** | 3 × 8-10 | 7 | 2-3 min | Posterior chain: hamstrings + glutes. Not a deadlift — controlled eccentric (3 sec down), hinge at the hip, stop at mid-shin. Develops the hip hinge pattern that feeds into your sumo deadlift on Lower B |
...
| 4 | **Incline DB Curl** | 3 × 10-12 | 7 | 60 sec | Bicep isolation at stretch. Incline position emphasizes the long head and provides a deep stretch at the bottom. Biceps get substantial indirect work from chin-ups and rows, so 3 direct sets is sufficient |
...
| # | Exercise | Sets × Reps | RPE | Rest | Why This Exercise |
|---|----------|-------------|-----|------|-------------------|
| 1 | **Sumo Deadlift** | 4 × 3-6 | 7-8 | 3-4 min | Your strongest hinge at ~116 kg × 5. Heavier, lower rep range than Lower A's RDL. Sumo reduces spinal loading vs conventional while emphasizing quads and adductors alongside posterior chain. Reset each rep from the floor — no touch-and-go during a cut (fatigue management) |
...
| 4 | **Leg Curl (machine)** | 3 × 10-12 | 7 | 90 sec | Hamstring isolation, second hit of the week (paired with Lower A). Sufficient frequency for hamstring maintenance during a cut |
...
|-------------|-----------|-------|----------------|--------|
| Chest | 7 | Bench 4 + Incline DB 3 | 10-14 | Low end — appropriate for a cut. OHP adds minor chest stimulus |
...
**Total weekly working sets: ~77** across 4 sessions (~19/session average)
