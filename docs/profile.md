...
|----------|-------------|------|------------|
| Floor Press (Smith) | 107 | 2 | 8 |
| Incline Bench Press | 75 | 8 | ~8 |
| Sumo Deadlift | 116 | 5 | ~7-8 |
| Barbell Row (supine) | 70 | 8 | — |
| Neutral Grip Pull-ups | BW (88.6) | 6 | — |
| DB Z-Press | 18 each | 10 | — |
| Squat variant | No data | — | — |
| Overhead press | No data | — | — |

## Running baseline

- **Weekly distance:** ~5 km (single run)
- **Easy pace:** 7:40 min/km
- **Avg HR:** 129 bpm (zone 2)
- **Experience level:** Beginner-recreational

## Recovery and lifestyle

- **Sleep:** OK (self-reported)
- **Job type:** Unknown
- **Stress level:** Unknown
- **Other activity:** None noted
